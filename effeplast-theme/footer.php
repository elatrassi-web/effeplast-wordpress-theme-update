...
<a href="https://wa.me/212666176691" target="_blank" rel="noopener noreferrer" class="fixed bottom-6 left-6 z-[60] w-14 h-14 text-white rounded-full flex items-center justify-center text-3xl shadow-lg shadow-green-500/30 hover:scale-110 hover:-translate-y-1 transition-all duration-300 group ep-hide-print animate-bounce" style="animation-duration: 3s; background-color: #25D366; padding: 15px;">
