                    ...
                    <div class="ep-logo-track flex items-center w-max" style="gap: 4rem;">
                        ...
                        for($i=0; $i<3; $i++) {
                            foreach($partner_logos as $logo_url) {
                                ?>
                                <div class="group flex items-center justify-center" style="flex: 0 0 150px; width: 150px; height: 100px;">
                                    <img src="<?php echo esc_url($logo_url); ?>" alt="Partenaire Effe Plast" class="max-w-[150px] max-h-[100px] object-contain transition-transform duration-300 hover:scale-110 cursor-pointer">
                                </div>
                                <?php
                            }
                        }
